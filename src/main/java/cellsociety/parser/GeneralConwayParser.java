...
/**
 * Author: Daniel Rodriguez-Florido This is a class whose sole purpose is to parse the various types
 * of rule strings
 */
...
public class GeneralConwayParser {
  ...
  public static void parseRuleString(String ruleString, Set<Integer> birthVals,
   ...
   * @param birthVals    The set that will contain the values of alive neighbors that warrant
   *                     survival
   ...
   */
  private static void parseBSNotation(String ruleString, Set<Integer> birthVals,
      Set<Integer> survivalVals) {
  ...
  private static void parseSBNotation(String ruleString, Set<Integer> birthVals,
      Set<Integer> survivalVals) {
