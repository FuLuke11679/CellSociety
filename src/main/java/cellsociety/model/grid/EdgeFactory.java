 ...
 * <p>
 * This class dynamically loads a specific {@code EdgeHandler} implementation based on the provided
 * edge type. If the provided edge type is null, empty, or if any error occurs during instantiation,
...
public class EdgeFactory {
   ...
   * "cellsociety.model.grid.handler.&lt;edgeType&gt;EdgeHandler" using reflection. If the edge type
   * is null, empty, or if an error occurs during instantiation, a {@link MirrorEdgeHandler} is
   * returned.
   * </p>
   *
   * @param edgeType the type of edge handler to create (e.g., "Infinite", "Mirror")
   * @return an instance of the requested {@code EdgeHandler}, or a default
   * {@code MirrorEdgeHandler} if creation fails
   */
