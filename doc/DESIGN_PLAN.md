...
current generation of the simulation. In our main class we will first perform all of our backend
...
Another major design consideration we discussed was how to handle the previous and current states of
